...
internal static class SiteAnalysisStepLogBuilder
{
    ...
    internal static SiteAnalysisStepLogEntry Entry(
        int stepNumber,
        string slug,
        string summary,
    ...
    internal static SiteAnalysisStepLogEntry Processing(
        int step,
        string slug,
        string summary,
    ...
    internal static SiteAnalysisStepLogEntry Schema(int step, SchemaOrgData data, string summary) =>
    ...
    internal static SiteAnalysisStepLogEntry SiteUrls(int step, SitemapData data, string summary) =>
    ...
    internal static SiteAnalysisStepLogEntry Nav(int step, NavMenuData data, string summary) =>
    ...
    internal static SiteAnalysisStepLogEntry Headings(int step, HomepageHeadings data, string summary) =>
    ...
    internal static SiteAnalysisStepLogEntry PageContent(int step, PageContentData data, string summary) =>
    ...
    internal static SiteAnalysisStepLogEntry SiteCrawl(int step, SiteCrawlData crawl, string summary) =>
    ...
    internal static SiteAnalysisStepLogEntry InternalLinks(
        int step,
        SiteCrawlData crawl,
    ...
    internal static SiteAnalysisStepLogEntry UrlPatterns(int step, UrlPatternData urlPatterns, string summary) =>
    ...
    internal static SiteAnalysisStepLogEntry SiteStructure(
        int step,
        SiteCrawlData crawl,
        InternalLinkData internalLinks,
    ...
    internal static SiteAnalysisStepLogEntry Merging(
        int step,
        int candidateCount,
        int mergedCount,
    ...
    internal static SiteAnalysisStepLogEntry Keywords(
        int step,
    ...
    internal static SiteAnalysisStepLogEntry SerpValidation(
        int step,
        PillarDemandEnrichment demand,
        string summary) =>
    ...
    internal static SiteAnalysisStepLogEntry Profile(
        int step, string primaryFocus, string audienceType, IEnumerable<string> focusTags, string summary) =>
        Entry(step, "profile", summary, new Dictionary<string, object?>
        {
            ["primaryFocus"] = primaryFocus,
            ["audienceType"] = audienceType,
            ["focusTags"] = focusTags.Take(SampleLimit).ToArray(),
        });

    internal static SiteAnalysisStepLogEntry LocalDisabled(int step, string summary) =>
    ...
    internal static SiteAnalysisStepLogEntry Local(
        int step,
    ...
    internal static SiteAnalysisStepLogEntry CoverageDisabled(int step, string summary) =>
    ...
    internal static SiteAnalysisStepLogEntry Coverage(
        int step,
        int pillarsCovered,
        int pillarsPartial,
        int pillarsGap,
    ...
    internal static SiteAnalysisStepLogEntry Scoring(
        int step,
    ...
    internal static SiteAnalysisStepLogEntry Complete(
