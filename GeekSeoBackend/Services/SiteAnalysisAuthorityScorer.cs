...
public sealed class SiteAuthorityScorer
{
    ...
    public void ScorePillars(IReadOnlyList<SiteAnalysisPillar> pillars)
    {
    ...
    public decimal ComputeTopicalAuthorityScore(IReadOnlyList<SiteAnalysisPillar> pillars)
    {
    ...
    private static decimal ComputePillarCoverageScore(SiteAnalysisPillar pillar)
    {
    ...
    private static string DetermineStrategicPriority(SiteAnalysisPillar pillar)
    {
    ...
    private static void MarkQuickWins(SiteAnalysisPillar pillar)
    {
    ...
    public static string DetermineCompetitionLevel(IReadOnlyList<SiteAnalysisCompetitor> competitors)
    {
