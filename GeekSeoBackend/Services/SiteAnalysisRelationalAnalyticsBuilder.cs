...
/// </summary>
internal static class SiteAnalysisRelationalAnalyticsBuilder
{
    public static IReadOnlyList<PillarCoverageMatrix> BuildCoverageMatrix(SiteAnalysisProfile profile)
    {
