  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-10">
              ...
              <>
                <div className="flex flex-wrap items-center gap-4">
                  ...
                  <div className="text-sm text-[var(--color-text-secondary)]">
                    <p>
                      Status: <span className="font-medium capitalize text-[var(--color-text-primary)]">{selected.status}</span>
                    </p>
      ...
      <p className="mt-12 text-sm">
        ...
        {' · '}
        <Link href="/app/projects" className="text-[var(--color-brand)] underline-offset-2 hover:underline">
          Projects
        </Link>
      </p>
    </main>
