...
export const OUTPUT_LABELS: Record<string, string> = {
  ...
  localSerpLocation: 'Local SERP market',
  localSerpAttempted: 'Local SERP queries attempted',
  localSerpSucceeded: 'Local SERP queries succeeded',
  localSerpFailed: 'Local SERP queries failed',
  localSerpFirstError: 'First local SERP error',
  localScopedCompetitors: 'Competitors with local SERP presence',
