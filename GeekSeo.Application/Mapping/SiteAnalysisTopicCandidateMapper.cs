...
public static class SiteAnalysisTopicCandidateMapper
{
    private const int MaxEvidenceItems = 5;
    private const int MaxSnippetLength = 120;

    public static IReadOnlyList<SiteAnalysisTopicCandidateBulkUpsert> FromSiteTopicProfile(
        Guid profileId,
        ...
        bool includeEvidence)
    {
        ...
        return fused.AllCandidates.Select(c =>
        {
            ...
            return new SiteAnalysisTopicCandidateBulkUpsert(
                null,
                profileId,
                c.Slug,
                c.Name,
