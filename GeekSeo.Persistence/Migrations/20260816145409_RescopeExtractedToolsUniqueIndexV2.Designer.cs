...
namespace GeekSeo.Persistence.Migrations
{
    ...
    [Migration("20260816145409_RescopeExtractedToolsUniqueIndexV2")]
    partial class RescopeExtractedToolsUniqueIndexV2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GeekSeo.Persistence.Entities.SeoSiteAnalyzerStepRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("SiteResearchId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SiteResearchId", "StepNumber");

                    b.HasIndex("UrlResearchId", "StepNumber");

                    b.ToTable("seo_site_analyzer_step_run", "geek_seo");
                });
            ...
            modelBuilder.Entity("GeekSeo.Persistence.Entities.SeoSiteResearch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("DiscoveredUrlsJson")
                        .IsRequired()
                        .HasColumnType("jsonb");

                    b.Property<string>("InternalLinkMapJson")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.ToTable("seo_site_research", "geek_seo");
                });

            modelBuilder.Entity("GeekSeo.Persistence.Entities.SeoSiteResearchPage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ExtractError")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("SiteResearchId");

                    b.HasIndex("SiteResearchId", "Url")
                        .IsUnique();

                    b.ToTable("seo_site_research_page", "geek_seo");
                });
            ...
            modelBuilder.Entity("GeekSeo.Persistence.Entities.SiteAnalysisPageSectionTree", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("site_analysis_page_section_trees", "geek_seo");
                });
            ...
            modelBuilder.Entity("GeekSeo.Persistence.Entities.SiteAnalysisProfileExtractedTool", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("SiteAnalysisProfileId", "SitePageId", "Name", "Department", "Body")
                        .IsUnique();

                    b.ToTable("extracted_tools", "geek_seo");
                });
            ...
            modelBuilder.Entity("GeekSeo.Persistence.Entities.SiteAnalysisProfileSitePage", b =>
                {
                    ...
                    b.Property<string>("RedirectChainJson")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("GeekSeo.Persistence.Entities.SiteAnalysisProfileUrlPatternTopic", b =>
                {
                    ...
                    b.HasIndex("SiteAnalysisProfileId", "Slug")
                        .IsUnique()
                        .HasDatabaseName("IX_site_analysis_profile_url_pattern_topics_SiteAnalysisProfi~1");
            ...
            modelBuilder.Entity("GeekSeo.Persistence.Entities.SeoSiteAnalyzerStepRun", b =>
                {
                    b.HasOne("GeekSeo.Persistence.Entities.SeoSiteResearch", "SiteResearch")
                        .WithMany("StepRuns")
                        .HasForeignKey("SiteResearchId")
                        .OnDelete(DeleteBehavior.Cascade);
