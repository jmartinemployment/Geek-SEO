...
This skill is for **competitive UX research**, **cloning or copying competitor features/components** into GeekSEO (your layout, APIs, and brand), and **dashboard upgrades** ([`plan-documents/UPGRADE-se-ranking-agency-serpapi.md`](../../../plan-documents/UPGRADE-se-ranking-agency-serpapi.md)). For full marketing-site pixel clones, use `clone-website` instead.
