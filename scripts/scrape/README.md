...
This tool does **not** replace **official APIs** for production data (SERP, keywords, backlinks). Runtime data strategy: [`plan-documents/SEO-PROVIDER-STRATEGY.md`](../../plan-documents/SEO-PROVIDER-STRATEGY.md).
